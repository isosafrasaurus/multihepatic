...
def optimize_for_target(fixed_index, fixed_value, default, target, lambda_reg = 1e-3, maxiter = 30):
    ...
    def objective_log(y):
        ...
        cost_primary = (net_flow - target)**2
...
def compute_chunk(chunk, variable_index, default, variable_name):
    chunk_rows = []
    for value in chunk:
        x_opt = optimize_for_target(variable_index, value, default, TARGET_FLOW, lambda_reg = 1e-10, maxiter = 30)
