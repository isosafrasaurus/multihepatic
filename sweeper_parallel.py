...
# These parameters are picklable.
TEST_GRAPH_NODES = {
    0: [0.000, 0.020, 0.015],
    1: [0.010, 0.020, 0.015],
    2: [0.022, 0.013, 0.015],
...
# Default parameter vector for flow computation.
...
# Modified sweep function that uses parallel processing.
def sweep_variable(variable_name, variable_values, default, directory=None, n_workers=None):
    ...
    rows = []
    # Initialize each worker with worker_init (which sets up WORK_DOMAIN).
