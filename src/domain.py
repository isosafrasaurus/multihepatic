...
class Domain1D:
    ...
    def from_vtk(
        ...
        *,
        ...
        We deliberately DO NOT call G.make_submeshes() here because the current
        coupling only needs G.mesh and G.mf, and make_submeshes() can trigger
        MPI communicator issues (EmbeddedMesh) in some environments.
        """
        from tissue.meshing import get_fg_from_vtk
        ...
        # IMPORTANT: no G.make_submeshes() here
