...
from xii import Average, Circle

from .core import ParamConstants
from .domain import AveragingRadius, BoundaryPoint, SegmentLength
...
def build_assembled_forms(
    ...
    *,
    ...
    if Omega_sink_subdomain is not None:
        if isinstance(Omega_sink_subdomain, MeshFunction) or hasattr(Omega_sink_subdomain, "array"):
    ...
    measures = Measures(dxOmega=dxOmega, dxLambda=dxLambda, dsOmega=dsOmega, dsOmegaSink=dsOmegaSink)
