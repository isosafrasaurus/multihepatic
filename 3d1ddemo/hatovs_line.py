...
def setup_problem(i, f, eps=None):
    ...
    alpha1, alpha0 = Constant(9.88e-2), Constant(0)
    
    beta = Constant(6.44E-5)
    ...
    bc_1d = Expression("63*x[2]+2", degree=0)
...
if __name__ == '__main__':
    ...
    uh3d, uh1d = wh
    File('plots/hatovs_pressure3d.pvd') << uh3d
    File('plots/hatovs_pressure1d.pvd') << uh1d
