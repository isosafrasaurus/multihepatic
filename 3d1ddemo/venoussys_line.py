...
def setup_problem(i, f, eps=None):
    ...
    alpha1, alpha0 = Constant(2), Constant(0)
    
    beta = Constant(1.81e-5)
    ...
    bc_1d = Expression("x[2]+1", degree=0)
...
if __name__ == '__main__':
    ...
    uh3d, uh1d = wh
    File('plots/vs_pressure3d.pvd') << uh3d
    File('plots/vs_pressure1d.pvd') << uh1d