...
X_DEFAULT    = [4.855e-05, 3.568e-08, 1.952e-07]  # [γ, γ_a, γ_R]
TARGET_FLOW  = 5.0e-6
LAMBDA_REG   = 1e-3
...
def worker_init(domain, lower_bounds, upper_bounds):
    ...
    # one dummy solve to JIT‐compile everything
    SOLVER.solve(
        gamma=X_DEFAULT[0],
        gamma_a=X_DEFAULT[1],
        gamma_R=X_DEFAULT[2],
